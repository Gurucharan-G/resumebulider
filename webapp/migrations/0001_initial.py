# Generated by Django 2.0.3 on 2021-04-25 04:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='reg_info',
            fields=[
                ('usr_id', models.IntegerField(default=45, primary_key=True, serialize=False, unique=True)),
                ('email', models.TextField(unique=True)),
                ('password', models.TextField(default='admin')),
                ('phone', models.IntegerField(default=8888)),
                ('name', models.TextField(default='noname')),
                ('date', models.DateTimeField(verbose_name=datetime.date(2021, 4, 25))),
            ],
        ),
        migrations.CreateModel(
            name='resume_data',
            fields=[
                ...
                ('usr_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webapp.reg_info')),
            ],
        ),
    ]
